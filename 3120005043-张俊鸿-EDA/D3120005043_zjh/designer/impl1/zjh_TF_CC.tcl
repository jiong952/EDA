...
# Thu Dec 23 15:16:32 2021

# (NEW DESIGN)

# create a new design
new_design -name "zjh_TF_CC" -family "ProASIC3"
...
set_defvar "BA_NAME" "zjh_TF_CC_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "zjh_TF_CC.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/zjh_TF_CC.edn}

# save the design database
save_design {zjh_TF_CC.adb}
