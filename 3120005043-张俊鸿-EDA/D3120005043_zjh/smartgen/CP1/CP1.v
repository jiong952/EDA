...
output ALB;
    ...
    AO1C AO1C_3 (.A(DataB[3]), .B(DataA[3]), .C(NOR2A_0_Y), .Y(
        AO1C_3_Y));
    AO1C AO1C_2 (.A(DataA[3]), .B(DataB[3]), .C(AO1C_3_Y), .Y(AO1C_2_Y)
        );
    AO1C AO1C_5 (.A(DataB[5]), .B(DataA[5]), .C(DataB[4]), .Y(AO1C_5_Y)
        );
    NOR3A NOR3A_0 (.A(OR2A_3_Y), .B(AO1C_5_Y), .C(DataA[4]), .Y(
        NOR3A_0_Y));
    AO1D AO1D_0 (.A(AO1C_1_Y), .B(AO1C_4_Y), .C(AO1C_2_Y), .Y(AO1D_0_Y)
        );
    AND2A AND_SIGN (.A(DataB[7]), .B(DataA[7]), .Y(U2));
    AO1C AO1C_0 (.A(DataA[0]), .B(DataB[0]), .C(OR2A_1_Y), .Y(AO1C_0_Y)
        );
    AND3 AND3_0 (.A(XNOR2_1_Y), .B(XNOR2_0_Y), .C(XNOR2_2_Y), .Y(
        AND3_0_Y));
    AO1C AO1C_4 (.A(DataB[2]), .B(DataA[2]), .C(OR2A_0_Y), .Y(AO1C_4_Y)
        );
    ...
    AO1C AO1C_1 (.A(DataB[3]), .B(DataA[3]), .C(AO1C_0_Y), .Y(AO1C_1_Y)
        );
    XNOR2 XNOR2_0 (.A(DataA[5]), .B(DataB[5]), .Y(XNOR2_0_Y));
    XNOR2 XNOR2_2 (.A(DataA[6]), .B(DataB[6]), .Y(XNOR2_2_Y));
    OR2A OR2A_2 (.A(DataB[6]), .B(DataA[6]), .Y(OR2A_2_Y));
    AO1 AND_AO21 (.A(le_OUT), .B(U1), .C(U2), .Y(ALB));
    ...
    OR2A OR_SIGN (.A(DataB[7]), .B(DataA[7]), .Y(U1));
...
// MGNTIMER:F
// MGNCMPL:T
// DESDIR:C:/D3120005043_zjh/smartgen\CP1
// GEN_BEHV_MODULE:F
